...
import edu.boun.edgecloudsim.applications.scenario_2.SampleScenarioFactory;
...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		if (args.length == 5){
			...
			configFile = "scenarios/scenario_1/config/default_config.properties";
			applicationsFile = "scenarios/scenario_1/config/applications.xml";
			edgeDevicesFile = "scenarios/scenario_1/config/edge_devices.xml";
			outputFolder = "sim_results/scenario_1/ite" + iterationNumber;
