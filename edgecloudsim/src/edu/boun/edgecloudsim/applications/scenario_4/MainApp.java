...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		if (args.length == 5){
			...
			configFile = "scenarios/scenario_4/config/default_config.properties";
			applicationsFile = "scenarios/scenario_4/config/applications.xml";
			edgeDevicesFile = "scenarios/scenario_4/config/edge_devices.xml";
			outputFolder = "sim_results/scenario_4/ite" + iterationNumber;
